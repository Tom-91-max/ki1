...
class CustomerController extends Controller
{
    ...
    {
        if($customer->delete()){
            return redirect()->route('customer.index')->with('ok','Delete a Customer successffuly');
        }else {
            return redirect()->route('customer.index')->with('no','Something error, Please try again');
        }
    }
}
