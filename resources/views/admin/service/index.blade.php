...
<form action="" method="GET" class="form-inline" role="form">
    ...
    <a href="{{ route('service.create') }}" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add new</a>
</form>
...
<table class="table table-hover">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ $model->link }}</td>
            <td>
                <img src="uploads/service/{{ $model->image }}" width="40">
            </td>
            ...
            <td class="text-right">
                <form action="{{ route('service.destroy', $model->id) }}" method="post">
                    ...
                    <a href="{{ route('service.edit', $model->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
